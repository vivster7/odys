...
function isAttribute(obj) {
    return obj.kind === graphile_build_pg_1.PgEntityKind.ATTRIBUTE;
}
exports.isAttribute = isAttribute;
function isConstraint(obj) {
    return obj.kind === graphile_build_pg_1.PgEntityKind.CONSTRAINT;
}
exports.isConstraint = isConstraint;
function isClass(obj) {
    return obj.kind === graphile_build_pg_1.PgEntityKind.CLASS;
}
exports.isClass = isClass;
function isProcedure(obj) {
    return obj.kind === graphile_build_pg_1.PgEntityKind.PROCEDURE;
}
exports.isProcedure = isProcedure;
function entityIsIdentifiedBy(obj, identifier, build) {
    const parts = parseIdentifierParts_1.default(identifier);
    if (parts.length === 1) {
