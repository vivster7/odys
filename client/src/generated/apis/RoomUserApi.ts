...
export class RoomUserApi extends runtime.BaseAPI {
  /**
   */
  async roomUserDeleteRaw(
    requestParameters: RoomUserDeleteRequest
  ...
  /**
   */
  async roomUserPatchRaw(
    requestParameters: RoomUserPatchRequest
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: runtime.HTTPQuery = {};
  ...
  /**
   */
  async roomUserPostRaw(
    requestParameters: RoomUserPostRequest
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: runtime.HTTPQuery = {};
